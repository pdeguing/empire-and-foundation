...
func planet(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.overview")
}

// GET /dashboard/planet/constructions
// Show the constructions page for a planet
func constructions(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.constructions")
}

// GET /dashboard/planet/factories
// Show the factories page for a planet
func factories(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.factories")
}

// GET /dashboard/planet/research
// Show the research page for a planet
func research(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.research")
}

// GET /dashboard/planet/fleets
// Show the fleets page for a planet
func fleets(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.fleets")
}

// GET /dashboard/planet/defenses
// Show the defenses page for a planet
func defenses(w http.ResponseWriter, r *http.Request) {
	generateHTML(w, r, nil, "layout", "private.navbar", "dashboard", "rightbar", "planet.layout", "planet.header", "planet.defenses")
}
